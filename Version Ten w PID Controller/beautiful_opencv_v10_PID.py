"""
Beautiful OpenCV Control Panel - Version 9.0
Modern, elegant GUI for multi-camera OpenCV processing
NOW RASPBERRY PI READY!

NEW IN V9:
- Raspberry Pi compatibility (ARM architecture support)
- Screenshot to clipboard (cross-platform Windows/Linux/Mac)
- Platform-specific optimizations
- All v8 features maintained
...
class BeautifulOpenCVPanelV9(TkinterDnD.Tk if HAS_DND else ctk.CTk):
    def __init__(self):
        super().__init__()
        
        self.title("OpenCV Vision Laboratory v9.0 🔬✨ [Pi Ready]")
...
if __name__ == "__main__":
    # Print platform info
    print(f"OpenCV Vision Laboratory v9.0")
